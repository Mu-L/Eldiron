...
tool_iso_paint = Herramienta 3D Paint (I). Pinta capas de belleza isométricas y detalles conscientes de la escena en la vista iso fija.
...
status_iso_paint_active = 3D Paint: haz clic o arrastra en la vista iso fija para previsualizar la colocación de pintura.
