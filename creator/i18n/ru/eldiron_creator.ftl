...
tool_iso_paint = Инструмент 3D Paint (I). Рисуйте изометрические beauty-слои и детали сцены в фиксированном iso-виде.
...
status_iso_paint_active = 3D Paint: щёлкните или перетащите в фиксированном iso-виде, чтобы просмотреть размещение краски.
