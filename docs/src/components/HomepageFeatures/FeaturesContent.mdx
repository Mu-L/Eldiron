...
> **Feb 25, 2026** Eldiron v0.9 preview screenshot. Eldiron v0.9 will feature character rigging via editable pixel art avatars (in up to 4 directions), procedural props and much more. It will become available in the first half of March.
>
...
- **Avatars** are Eldiron’s character sprite definitions, and you can create and paint them directly in the integrated tile editor using predefined body-part marker colors and anchor points.
