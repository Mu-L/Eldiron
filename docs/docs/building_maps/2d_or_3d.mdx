...
Tiles, Art Palette entries, and geometry objects in 3D support preset-based render materials and can be painted onto editable geometry surfaces.
...
<Admonition type="tip" title="Organic 3D Painting">
The 3D Paint Tool adds persistent surface-space detail directly to 3D geometry. Use geometry for collision and structure, then paint moss, cracks, dirt, grass, puddles, stamps, and generated patterns onto its surfaces. The result remains attached to the scene in isometric, orbit, and first-person cameras.
</Admonition>
