...
The *Rect* tool does not layer tiles. When you draw over an existing tile, the tile will be replaced with the new tile. Hold *Shift* while drawing to erase, and hold *Cmd/Ctrl* to draw straight lines.
